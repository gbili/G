...
{	
	 ...
	 * @var unknown_type
	 */
	static public $baseAdapterClassName = 'G_Country_Normalizer_Adapter';
	...
	static public function getInstance()
	{
		if (null === self::$_adapterInstance) {
			...
			if (!(self::$_adapterInstance instanceof G_Country_Normalizer_Adapter_Abstract)) {
				throw new G_Country_Normalizer_Adapter_Exception('Error : The adapter must extend G_Country_Normalizer_Adapter_Abstract');
			}
		}
