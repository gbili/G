-- MySQL dump 10.11
--
-- Host: localhost    Database: jeveduuc
-- ------------------------------------------------------
...
--
-- Table structure for table `G_Vid_CatWithThumb`
--

DROP TABLE IF EXISTS `G_Vid_CatWithThumb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `G_Vid_CatWithThumb` (
  `categoryId` int(10) unsigned NOT NULL default '0',
  `vidId` int(10) unsigned NOT NULL default '0',
  `vidsCount` int(10) unsigned NOT NULL default '0',
  `catName` varchar(255) NOT NULL default '',
  `catSlug` varchar(255) NOT NULL default '',
  `imageLocalUrl` varchar(255) NOT NULL default '',
  `viewCount` int(10) unsigned NOT NULL default '0',
...
--
-- Dumping data for table `G_Vid_CatWithThumb`
--

LOCK TABLES `G_Vid_CatWithThumb` WRITE;
/*!40000 ALTER TABLE `G_Vid_CatWithThumb` DISABLE KEYS */;
/*!40000 ALTER TABLE `G_Vid_CatWithThumb` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `G_Dump_Meta`
--

DROP TABLE IF EXISTS `G_Dump_Meta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `G_Dump_Meta` (
  `dumpId` int(10) unsigned NOT NULL auto_increment,
  `unixTS` int(10) unsigned NOT NULL default '0',
  `instancesCount` int(10) unsigned NOT NULL default '0',
  `lastAvailableData` text NOT NULL,
  PRIMARY KEY  (`dumpId`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `G_Dump_Meta`
--

LOCK TABLES `G_Dump_Meta` WRITE;
/*!40000 ALTER TABLE `G_Dump_Meta` DISABLE KEYS */;
/*!40000 ALTER TABLE `G_Dump_Meta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `G_Exception`
--

DROP TABLE IF EXISTS `G_Exception`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `G_Exception` (
...
--
-- Dumping data for table `G_Exception`
--

LOCK TABLES `G_Exception` WRITE;
/*!40000 ALTER TABLE `G_Exception` DISABLE KEYS */;
/*!40000 ALTER TABLE `G_Exception` ENABLE KEYS */;
UNLOCK TABLES;
